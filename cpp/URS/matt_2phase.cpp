...
static ClassDesc MatterStable_ClassDesc(
    typeid(MatterStable),
    "MatterStable",
    1,
    "Matter_category",
    create<MatterStable>);
static ClassDesc MatterLiqSol_ClassDesc(
    typeid(MatterLiqSol),
    "MatterLiqSol",
    1,
    "Matter_category",
...
static ClassDesc MatterBinodalSpinodal_ClassDesc(
    typeid(MatterBinodalSpinodal),
    "MatterBinodalSpinodal",
    1,
    "Matter_category",
    create<MatterBinodalSpinodal>);
//#endif


static ClassDesc TwoPhaseBoundary_ClassDesc(
    typeid(MatterStable::TwoPhaseBoundary),
    "TwoPhaseBoundary",
    1,
    "MatterBnd_category",
    create<MatterStable::TwoPhaseBoundary>);
static ClassDesc LiquidSolidBnd_ClassDesc(
    typeid(MatterLiqSol::LiquidSolidBnd),
    "LiquidSolidBnd",
    1,
    "MatterBnd_category",
    create<MatterLiqSol::LiquidSolidBnd>);

static ClassDesc FreeELiqSol_ClassDesc(
    typeid(FreeELiqSol),
    "FreeELiqSol",
    1,
    "MatterFreeE_category",
    create<FreeELiqSol>);
static ClassDesc FreeELiqSol_Bnd_ClassDesc(
    typeid(FreeELiqSol_Bnd),
    "FreeELiqSol_Bnd",
    1,
    "",
    create<FreeELiqSol_Bnd>);


MatterStable::TwoPhaseBoundary
    *MatterStable::TwoPhaseBoundary::TwoPhaseBoundaryStaticPtr = NULL;
...
int MatterStable::TwoPhaseBoundary::SetDP(
    VecCl &V,
    VecCl &D,
    VecCl &P,
    int &SpinIndMin,
...
map<Stroka, double> MatterStable::TwoPhaseBoundary::ClcBnd(
    double Temp,
    double Dmin,
    double Dmax,
    double NumPnt,
    ...
    Bnd.Mis = Misfit;
    Bnd.NumPnt = NumPnt;
    Bnd.NumSplPnt = NumSplPnt;
    return Bnd.MakeBndPnt();
};
Stroka MatterStable::TwoPhaseBoundary::MakeSpline(
    CurveSpline &spl,
    int Nspl,
    double Misf,
    double *y,
    ...
    if(!spl.Generate(Nspl, Misf, 0, x, y, NumX))
        throw info_except(
            "GenerateTwoPhaseBnd SaveBound error Generating %s spline\n", err_name);
