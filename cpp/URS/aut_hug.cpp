...
void Hug1(Int_Par &P1, Int_Par &Pr1, double &Dr1, MatterIO *Mat1, double Pres) {
    MatterAdiabat = Mat1;
    Pr1.Pres = Pres;
    HugPres(P1.Velo, P1.Dens, P1.Pres, P1.Ener, Pr1.Velo, Pr1.Dens, Pres, Pr1.Ener, Dr1);
    Dr1 = -Dr1 + P1.Velo;
};
