...
static ClassDesc FreeESumMatter_ClassDesc(
    typeid(FreeESumMatter),
    "FreeESumMatter",
    1,
    "MatterFreeE_category",
    create<FreeESumMatter>);
...
FreeESumMatter::FreeESumMatter() : FreeEIOFind("material.cfg", "MatterSumH2Met") {
