...
static ClassDesc ClcDissociation_FreeEDis2_ClassDesc(typeid(ClcDissociation::FreeEDis2),"ClcDissociation::FreeEDis2",1,"MatterFreeE_category",create<ClcDissociation::FreeEDis2>);
