...
ForceLinkVoid<UrsCurve_InOut> Dummy_UrsCurve_InOut;

ForceLinkVoid<UrsCurve_OneVarFunction> Dummy_UrsCurve_OneVarFunction;
ForceLinkVoid<UrsCurve_NamedOneVarFunction> Dummy_UrsCurve_NamedOneVarFunction;


ForceLinkVoid<UrsCurve_Calculator> Dummy_UrsCurve_Calculator;

ForceLinkVoid<UrsCurve_BrightTempClc> Dummy_UrsCurve_BrightTempClc;
