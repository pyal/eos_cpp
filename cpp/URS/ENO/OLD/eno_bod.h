...
struct Poli3CoefStruct  
 { double a[MaxPolynomOrder],pos[MaxPolynomOrder]; int k[MaxPolynomOrder];};
...
struct Body
{
   ...
   Body(){Matter=NULL;NumPnt=0;IterCalcS=0;NumSkipS=10;}
   Body(int NPnt,int NIntPar,MatterIO *Mat,double Vis,double Vis2)
    {Matter=NULL;NumPnt=0;IterCalcS=0;NumSkipS=10;Create(NPnt,NIntPar,Mat,Vis,Vis2);}
   void DeleteBody();
