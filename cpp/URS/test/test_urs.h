...
struct TestCase_Urs_Static : TestCase_Std   //TestCase_Buffered
{
    ...
    static TestCase_Urs_Static *Restore(DescribedClass *ptr) {
        ...
        if(!cur)
            throw(info_except("ptr is not TestCase_Urs_Static"));
        return cur;
    }
    static void Test_Func(TestCase *ptr) {
        ...
        cur->Text_Func_Out(
            &ABUSTEEL_resources[0],
            sizeof(ABUSTEEL_resources) / sizeof(ResourcesStruct),
            "ABUSTEEL");
        ResourcesStruct FREEEH2ELECTRON_resources[] = {{FREEEH2ELECTRON_HUG_TEST,
                                                        FREEEH2ELECTRON_HUG_CFG,
                                                        1e-6,
                                                        "FreeEH2Electron.Hug"},
                                                       {FREEEH2ELECTRON_ISOT_TEST,
                                                        FREEEH2ELECTRON_ISOT_CFG,
                                                        1e-6,
                                                        "FreeEH2Electron.IsoT"}};
        cur->Text_Func_Out(
            &FREEEH2ELECTRON_resources[0],
            sizeof(FREEEH2ELECTRON_resources) / sizeof(ResourcesStruct),
            "FREEEH2ELECTRON");
        ...
        cur->Text_Func_Out(
            &FREEEIDEAL_resources[0],
            sizeof(FREEEIDEAL_resources) / sizeof(ResourcesStruct),
            "FREEEIDEAL");
        ...
        cur->Text_Func_Out(
            &GASONEATOM_resources[0],
            sizeof(GASONEATOM_resources) / sizeof(ResourcesStruct),
            "GASONEATOM");
        ...
        cur->Text_Func_Out(
            &VANDERVALSN2_resources[0],
            sizeof(VANDERVALSN2_resources) / sizeof(ResourcesStruct),
            "VANDERVALSN2");
        ResourcesStruct FREEEMETHCOLD_resources[] = {
            {FREEEMETHCOLD_HUG_TEST, FREEEMETHCOLD_HUG_CFG, 1e-6, "FreeEMetHCold.Hug"},
            {FREEEMETHCOLD_ISOT_TEST,
             FREEEMETHCOLD_ISOT_CFG,
             1e-6,
             "FreeEMetHCold.IsoT"}};
        cur->Text_Func_Out(
            &FREEEMETHCOLD_resources[0],
            sizeof(FREEEMETHCOLD_resources) / sizeof(ResourcesStruct),
            "FREEEMETHCOLD");
        ...
        cur->Text_Func_Out(
            &MURNAGANGEKS_resources[0],
            sizeof(MURNAGANGEKS_resources) / sizeof(ResourcesStruct),
            "MURNAGANGEKS");
        ...
        cur->Text_Func_Out(
            &ZUBAREVGEKS_resources[0],
            sizeof(ZUBAREVGEKS_resources) / sizeof(ResourcesStruct),
            "ZUBAREVGEKS");
        ...
        cur->Text_Func_Out(
            &ABUEXPFITBR5_resources[0],
            sizeof(ABUEXPFITBR5_resources) / sizeof(ResourcesStruct),
            "ABUEXPFITBR5");
        ...
        cur->Text_Func_Out(
            &HISCHBR4_resources[0],
            sizeof(HISCHBR4_resources) / sizeof(ResourcesStruct),
            "HISCHBR4");
        ResourcesStruct IVLPOLYSTERENE_resources[] = {
            {IVLPOLYSTERENE_HUG_TEST, IVLPOLYSTERENE_HUG_CFG, 1e-6, "IVLPolysterene.Hug"},
            {IVLPOLYSTERENE_ISOE_TEST,
             IVLPOLYSTERENE_ISOE_CFG,
             1e-6,
             "IVLPolysterene.IsoE"}};
        cur->Text_Func_Out(
            &IVLPOLYSTERENE_resources[0],
            sizeof(IVLPOLYSTERENE_resources) / sizeof(ResourcesStruct),
            "IVLPOLYSTERENE");
        ...
        cur->Text_Func_Out(
            &MO_BUSHMAN_resources[0],
            sizeof(MO_BUSHMAN_resources) / sizeof(ResourcesStruct),
            "MO_BUSHMAN");
        ...
        cur->Text_Func_Out(
            &NI_BUSHMAN_resources[0],
            sizeof(NI_BUSHMAN_resources) / sizeof(ResourcesStruct),
            "NI_BUSHMAN");


        // Ross type
        ResourcesStruct FREEEROSSH2DISGOOD_resources[] = {{FREEEROSSH2DISGOOD_ISOT_TEST,
                                                           FREEEROSSH2DISGOOD_ISOT_CFG,
                                                           1e-6,
                                                           "FreeERossH2DisGood.IsoT"}};
        cur->Text_Func_Out(
            &FREEEROSSH2DISGOOD_resources[0],
            sizeof(FREEEROSSH2DISGOOD_resources) / sizeof(ResourcesStruct),
            "FREEEROSSH2DISGOOD");
        ResourcesStruct FREEEROSSN2HE1_resources[] = {{FREEEROSSN2HE1_ISOT_TEST,
                                                       FREEEROSSN2HE1_ISOT_CFG,
                                                       1e-6,
                                                       "FreeERossN2He1.IsoT"}};
        cur->Text_Func_Out(
            &FREEEROSSN2HE1_resources[0],
            sizeof(FREEEROSSN2HE1_resources) / sizeof(ResourcesStruct),
            "FREEEROSSN2HE1");
        ResourcesStruct FREEEROSSN2VCOOL_resources[] = {{FREEEROSSN2VCOOL_ISOT_TEST,
                                                         FREEEROSSN2VCOOL_ISOT_CFG,
                                                         1e-6,
                                                         "FreeERossN2Vcool.IsoT"}};
        cur->Text_Func_Out(
            &FREEEROSSN2VCOOL_resources[0],
            sizeof(FREEEROSSN2VCOOL_resources) / sizeof(ResourcesStruct),
            "FREEEROSSN2VCOOL");
        ResourcesStruct FREEEROSSN2XE1_resources[] = {{FREEEROSSN2XE1_ISOT_TEST,
                                                       FREEEROSSN2XE1_ISOT_CFG,
                                                       1e-6,
                                                       "FreeERossN2Xe1.IsoT"}};
        cur->Text_Func_Out(
            &FREEEROSSN2XE1_resources[0],
            sizeof(FREEEROSSN2XE1_resources) / sizeof(ResourcesStruct),
            "FREEEROSSN2XE1");
        ResourcesStruct XESTR1_resources[] = {
            {XESTR1_ISOT_TEST, XESTR1_ISOT_CFG, 1e-6, "XeStr1.IsoT"}};
        cur->Text_Func_Out(
            &XESTR1_resources[0],
            sizeof(XESTR1_resources) / sizeof(ResourcesStruct),
            "XESTR1");
    }
};
