...
static ClassDesc UrsCurve_BrightTempClc_ClassDesc(
    typeid(UrsCurve_BrightTempClc),
    "UrsCurve_BrightTempClc",
    1,
    "URS_Curve_ClcVar_category",
    create<UrsCurve_BrightTempClc>);


UrsCurve_BrightTempClc::UrsCurve_BrightTempClc()
    : OpacityDifCalib2Measure(1),
      WaveLength(500),
      CalibTemp(2000),
      CalibSignal(0.5),
      UseFixedCalibEmissivity(1),
      InterFilterFormName("InterFilterForm"),
      DetectorEmissivityName("DetectorEmissivityFile"),
      CalibEmissivityName("CalibEmissivityFile"),
      VarSignalName("File.x"){};
