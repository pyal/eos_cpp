/* REGRID.f -- translated by f2c (version 19970805).
	...
	integer *lwrk, integer *iwrk, integer *kwrk, integer *ier)
{
    ...
    /* Local variables */
    integer kndx, kndy, lfpx, lfpy, jwrk, knrx, knry, i__, j, maxit, nminx, 
	    nminy, kwest, lwest, nc;
    extern /* Subroutine */ int fpchec_(real *, integer *, real *, integer *, 
	    integer *, integer *);
    integer mz;
    extern /* Subroutine */ int fpregr_(integer *, real *, integer *, real *, 
