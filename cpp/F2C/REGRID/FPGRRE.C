/* FPGRRE.f -- translated by f2c (version 19970805).
...
/*  main loop for the different grid points. */
	...
	for (i2 = 1; i2 <= i__2; ++i2) {
	    ...
	    numy1 = numy + 1;
	    ++iz;
/*  evaluate s(x,y) at the current grid point by making the sum of
 the */
/*  cross products of the non-zero b-splines at (x,y), multiplied 
with */
