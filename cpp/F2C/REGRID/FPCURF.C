/* fpcurf.f -- translated by f2c (version 19970805).
...
/* Subroutine */ int fpcurf_(integer *iopt, real *x, real *y, real *w, 
	integer *m, real *xb, real *xe, integer *k, real *s, integer *nest, 
	real *tol, integer *maxit, integer *k1, integer *k2, integer *n, real 
	*t, real *c__, real *fp, real *fpint, real *z__, real *a, real *b, 
	real *g, real *q, integer *nrdata, integer *ier)
{
    ...
    real fpms, term, pinv, h__[7];
    integer i__, j, l;
    real p, fpold, fpart, f1, f2, f3;
    integer i1, i2;
    real store;
    integer i3, k3;
    real p1, p2, p3;
    integer l0, nplus, nrint, n8;
    extern /* Subroutine */ int fpback_(real *, real *, integer *, integer *, 
	    real *, integer *);
    integer it;
    real rn, wi, xi, yi;
    extern /* Subroutine */ int fpdisc_(real *, integer *, integer *, real *, 
	    integer *);
    extern doublereal fprati_(real *, real *, real *, real *, real *, real *);
    extern /* Subroutine */ int fpbspl_(real *, integer *, integer *, real *, 
	    integer *, real *), fprota_(real *, real *, real *, real *), 
	    fpgivs_(real *, real *, real *, real *), fpknot_(real *, integer *
	    , real *, integer *, real *, integer *, integer *, integer *, 
	    integer *);
    real fp0;
    integer mk1, nk1;
    real acc, one, cos__, sin__;
    integer new__;
    real piv;
    integer ich1, ich3;
    real con1, con4, con9;
