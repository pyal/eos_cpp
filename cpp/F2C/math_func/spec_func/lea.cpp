// ERF and IERF functions ( error function, inverse error function err = 1e-9 )
...
#define LEVMAX 10
    ...
    double quad8_stdnormal_pdf(double a, double b, double Q)   //Q = 1.0)
    {
 ...
 */
    ...
    double stdnormal_cdf(double u) {
        ...
        const double d[9] = {1.00000000000000000e00,
        ...
        const double p[6] = {1.63153871373020978e-2,
                             3.05326634961232344e-1,
                             3.60344899949804439e-1,
                             1.25781726111229246e-1,
                             1.60837851487422766e-2,
                             6.58749161529837803e-4};
        const double q[6] = {1.00000000000000000e00,
        ...
        if(y <= 4.0) {
            ...
            y = ((((((((c[0] * y + c[1]) * y + c[2]) * y + c[3]) * y + c[4]) * y + c[5]) *
                ...
                /
                ((((((((d[0] * y + d[1]) * y + d[2]) * y + d[3]) * y + d[4]) * y + d[5]) *
                       y +
                   d[6]) *
                      y +
                  d[7]) *
            ...
            y = 2 / (y * y);
            y = y *
                (((((p[0] * y + p[1]) * y + p[2]) * y + p[3]) * y + p[4]) * y + p[5]) /
 ...
 */
    //double SpecFunc::stdnormal_inv(double p)
