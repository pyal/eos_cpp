/* dchinf.f -- translated by f2c (version 20000118).
...
/* Subroutine */ int dchinf_(integer *numfun, U_fp funsub, doublereal *period,
	 doublereal *gamma, doublereal *a, doublereal *b, integer *minpts, 
	integer *maxpts, doublereal *epsabs, doublereal *epsrel, integer *
	wrksub, integer *nw, integer *emax, integer *key, integer *restar, 
	integer *neval, integer *ifail)
{
    ...
    integer limit;
    doublereal width;
    extern /* Subroutine */ int dgainf_(integer *, U_fp, doublereal *, 
	    doublereal *, doublereal *, integer *, integer *);

/* ***BEGIN PROLOGUE DCHINF */
/* ***REFER TO DQAINF */
/* ***PURPOSE  DCHINF checks the validity of the input parameters to */
/*            DQAINF. */

/* ***LAST MODIFICATION 93-05-05 */

/* ***DESCRIPTION */
/*   DCHINF computes IFAIL as a function of the input */
/*   parameters to DQAINF, and checks the validity of the input */
/*   parameters to DQAINF. */
...
/* ***FIRST EXECUTABLE STATEMENT DCHINF */
...
/*   If the user gives GAMMA <= 0 and KEY = 2 then DQAINF will try to */
/*   estimate GAMMA. */
...
/*   The routine DGAINF may detect errors: */
...
/*   compute GAMMA sufficiently accurate. Remedy: use KEY = 1 instead. */
    ...
    if (*gamma <= 0. && *key == 2) {
	dgainf_(numfun, (U_fp)funsub, &b[1], period, gamma, neval, ifail);
	return 0;
    }
