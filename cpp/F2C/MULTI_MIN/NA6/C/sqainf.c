/* sqainf.f -- translated by f2c (version 20000118).
...
/* Subroutine */ int sqainf_(integer *numfun, U_fp funsub, real *period, real 
	...
	neval, integer *ifail, logical *done, real *work, integer *iwork)
{
    integer lenw, nsub, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12, 
	    i13, i14;
    extern /* Subroutine */ int sadinf_(integer *, U_fp, real *, real *, real 
	    *, real *, integer *, integer *, integer *, integer *, real *, 
	    ...
	    real *, real *, integer *, integer *, integer *), schinf_(integer 
	    *, U_fp, real *, real *, real *, real *, integer *, integer *, 
	    real *, real *, integer *, integer *, integer *, integer *, 
	    integer *, integer *, integer *);

/* ***BEGIN PROLOGUE SQAINF */
...
/*   SQAINF is a driver for the integration routine SADINF. */

/*   SADINF either (1) repeatedly subdivides the interval with greatest */
...
/*   When SQAINF computes estimates to a vector of integrals, */
...
/*   SQAINF to all integrands in one call. For integrals that varies */
/*   continuously as functions of some parameter, the estimates */
/*   produced by SQAINF will also vary continuously when the same */
...
/*            In this case the only parameters for SQAINF that may */
/*            be changed (with respect to the previous call of SQAINF) */
...
/*     NEVAL  Integer. */
/*            Number of function evaluations used by SQAINF. */
/*     IFAIL  Integer. */
...
/*              to obtain the required accuracy. In this case SQAINF */
...
/*   the intervals. When passed on to SADINF, WORK is split into four */
...
/*   interval. The data structures for the intervals are in SADINF */
/*   organized as a heap, and the size of GREATE(I) defines the */
/*   position of interval I in the heap. The heap is maintained by the */
/*   program STRINF and we use a partially ordered list of pointers, */
/*   saved in IWORK. When passed on to SADINF, IWORK is split into three */
...
/*   sub-interval, SGAINT, uses WORK2 as a work array. */
...
/*   Check the input parameters. */
    ...
    /* Function Body */
    schinf_(numfun, (U_fp)funsub, period, gamma, &a[1], &b[1], minpts, maxpts,
...
/*   Compute the size of the temporary work space needed in DADINF. */
    ...
    lenw = *numfun * 38;
    sadinf_(numfun, (U_fp)funsub, period, gamma, &a[1], &b[1], wrksub, emax, 
