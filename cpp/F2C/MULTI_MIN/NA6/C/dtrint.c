/* dtrint.f -- translated by f2c (version 20000118).
...
/* Subroutine */ int dtrint_(integer *dvflag, integer *sbrgns, doublereal *
	greate, integer *list, integer *new__)
{
    integer pntr;
    doublereal great;
    integer subrgn, subtmp;

/* ***BEGIN PROLOGUE DTRINT */
/* ***REFER TO DQAINF */
/* ***PURPOSE  DTRINT maintains a heap of subregions. */
/* ***DESCRIPTION DTRINT maintains a heap of subregions. The subregions */
...
/* ***FIRST EXECUTABLE STATEMENT DTRINT */
