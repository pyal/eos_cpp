/* tn.f -- translated by f2c (version 20000118).
...
/* Subroutine */ int tn_(integer *ierror, integer *n, doublereal *x, 
	doublereal *f, doublereal *g, doublereal *w, integer *lw, U_fp sfun)
{
    /* Format strings */
...
/* MINIMIZE THE FUNCTION */
    ...
    lmqn_(ierror, n, &x[1], f, &g[1], &w[1], lw, (U_fp)sfun, &msglvl, &maxit, 
...
/* MINIMIZE FUNCTION */
    ...
    lmqnbc_(ierror, n, &x[1], f, &g[1], &w[1], lw, (U_fp)sfun, &low[1], &up[1]
...
8)";
    ...
    extern /* Subroutine */ int setucr_(doublereal *, integer *, integer *, 
	    integer *, doublereal *, doublereal *, doublereal *, doublereal *,
	     doublereal *, S_fp, doublereal *, doublereal *);
    doublereal rtleps;
    integer ipivot, nm1;
...
doublereal NashMin_Mach_Epsilon=2e-16;
doublereal mchpr1_()
{
    /* System generated locals */
    doublereal ret_val;
