/* dqawoe.f -- translated by f2c (version 20000118).
	...
	chebmo)
{
    ...
    doublereal small, erro12, width, a1, a2, b1, b2, defab1, defab2, oflow;
    integer ierro, ktmin, nrmax;
    doublereal uflow;
    extern doublereal d1mach_(integer *);
    integer nrmom;
    logical noext;
    integer iroff1, iroff2, iroff3;
    doublereal res3la[3], error1, error2;
    integer id;
    doublereal rlist2[52];
    integer numrl2;
