/* dqc25s.f -- translated by f2c (version 20000118).
	...
	integer *nev)
{
    ...
    /* Local variables */
    doublereal fval[25], res12, res24;
    integer isym;
    doublereal cheb12[13], cheb24[25];
    integer i__;
    doublereal u, hlgth, centr;
    ...
    extern doublereal dqwgts_(doublereal *x, doublereal *a, doublereal *b, 
							  doublereal *alfa, doublereal *beta, integer *integr);
    doublereal fix;
