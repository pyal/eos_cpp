/* dqc25c.f -- translated by f2c (version 20000118).
	...
	neval)
{
    ...
    doublereal p2, p3, p4, cc;
    extern /* Subroutine */ int dqcheb_(doublereal *, doublereal *, 
	    doublereal *, doublereal *);
    integer kp;
    doublereal resabs, resasc;
    extern doublereal dqwgtc_(doublereal *x, doublereal *c__, doublereal *p2, 
							  doublereal *p3, doublereal *p4, integer *kp);
    doublereal ak22;
