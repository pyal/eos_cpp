/* dqc25f.f -- translated by f2c (version 20000118).
	...
	chebmo)
{
    ...
    /* Local variables */
    doublereal conc, asap, par22, fval[25], estc, cons;
    integer iers;
    doublereal ests;
    integer isym, noeq1;
    doublereal cheb12[13], d__[25], cheb24[25];
    integer i__, j, k, m;
    doublereal v[28], resc12, resc24, hlgth, centr;
    extern /* Subroutine */ int dqk15w_(D_fp, D_fp, doublereal *, doublereal *
	    ...
	    *, doublereal *, doublereal *, doublereal *, doublereal *), 
	    ...
	    doublereal *, integer *);
    doublereal ress12, ress24, d1[25], d2[25], oflow;
    integer noequ;
    extern doublereal d1mach_(integer *);
    doublereal p2, p3, p4, ac, an, as;
    extern /* Subroutine */ int dqcheb_(doublereal *, doublereal *, 
	    doublereal *, doublereal *);
    doublereal cospar;
    extern doublereal dqwgtf_(doublereal *x, doublereal *omega, doublereal *p2, 
							  doublereal *p3, doublereal *p4, integer *integr);
    doublereal parint, sinpar, an2, ass, par2;
