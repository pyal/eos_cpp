/* dqng.f -- translated by f2c (version 20000118).
	...
	integer *neval, integer *ier)
{
    ...
    /* Local variables */
    doublereal absc, fval, res10, res21, res43, res87, fval1, fval2;
    integer k, l;
    doublereal hlgth, centr, reskh, uflow;
    extern doublereal d1mach_(integer *);
    doublereal epmach, dhlgth, resabs, resasc, fcentr, savfun[21], fv1[5], 
	    fv2[5], fv3[5], fv4[5];
