/* curfit.f -- translated by f2c (version 19970805).
...
/* Subroutine */ int curfit_(integer *iopt, integer *m, real *x, real *y, 
	...
	integer *n, real *t, real *c__, real *fp, real *wrk, integer *lwrk, 
	integer *iwrk, integer *ier)
{
    ...
    /* Local variables */
    integer nmin, i__, j, maxit, k1, k2, lwest, ia, ib, ig;
    extern /* Subroutine */ int fpchec_(real *, integer *, real *, integer *, 
	    integer *, integer *);
    integer iq, iz;
    extern /* Subroutine */ int fpcurf_(integer *, real *, real *, real *, 
