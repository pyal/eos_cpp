...
URS_Curve {
    ...
    NumIter  $NumIter
        ...
        MatterSpl  EOS_Savable { MatterFreeE MatterFreeSpl  $cfg->{'$Spl_FileName'} } 
        EOS_Spl    UrsCurve_FreeE { NameDenc $NameDencHug NameTemp $NameTemperature NameMatter MatterSpl }   
