...
static ClassDesc NPolygon_TPolyMarchRegionTest_ClassDesc(typeid(NPolygon::TPolyMarchRegionTest),"NPolygon::TPolyMarchRegionTest",1,"NPolygon::March_category",create<NPolygon::TPolyMarchRegionTest>);
