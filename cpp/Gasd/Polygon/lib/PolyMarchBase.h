...
namespace NPolygon {
    ...
    struct TPolyMarchBody : TPolyMarchRegionBase {
        ...
        Stroka MakeHelp() {
            Stroka help = "Class is a main driver for time marching calculation. Uses marcher for time step clc.";
        ...
        void SaveIter(fstream &outFile, double time, TPolyRegion *reg, const vector<Stroka> &outNames, const TRegionBounds &bnds) {
            //outFile<<"EndIter\n";
