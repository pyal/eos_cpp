...
namespace NPolygon {
    ...
    struct TestCase_Gasd_Static : TestCase_Std//TestCase_Buffered
    {
	    ...
	    static void Test_Simple(TestCase *ptr) { 
            ...
            Ref<TTestSimple> t1 = new TTestSimple(new TTestSimple), t2 = new TTestSimple, t3 = new TTestSimple;
            Stroka objStr1 = SavableClass::object2string(t1);
            t2 = SavableClass::TestType<TTestSimple>(SavableClass::string2object(SavableClass::object2string(t1.pointer())));
            ...
            if (objStr1 != objStr2 || objStr1 != objStr3 || objStr1 != objStr4)
                throw info_except(" Objects are different. Fst:\n%s\nSec:\n%s\nThird:\n%s\nFourth\n%s\n", ~objStr1, ~objStr2, ~objStr3, ~objStr4); 
        }
	    static void Test_ListSave(TestCase *ptr) { 
            ...
            Stroka objStr2 = SavableClass::object2string(t2, SavableClass::SingleFileStorage);
            Ref<TTest> t3 = new TTest; 
            t3->LoadClass(*t2);
            Stroka objStr3 = SavableClass::object2string(t3, SavableClass::SingleFileStorage);
            Ref<TTest> t4 = new TTest; 
            *t4 = *t2;
            t4->LoadClass(*t2);
            Stroka objStr4 = SavableClass::object2string(t4, SavableClass::SingleFileStorage);
            ...
            if (objStr1 != objStr2 || objStr1 != objStr3 || objStr1 != objStr4 || objStr1 != objStr5)
                throw info_except(" Objects are different. Fst:\n%s\nSec:\n%s\nThird:\n%s\nFourth:\n%s\nFifth:\n%s\n", ~objStr1, ~objStr2, ~objStr3, ~objStr4, ~objStr5); 
    ...
    cout<<" objStr1\n"<<objStr1<<"\n";
            ...
            reg2 = SavableClass::TestType<NPolygon::TPolyRegion>(SavableClass::string2object(objStr1));
    ...
    //cout<<" objStr3\n"<<objStr3<<"\n";
            ...
            //cout<<" Fst class :\n"<<~objStr1<<" Sec class:\n"<<~objStr2<<" Third class:\n"<<~objStr3;
            if (objStr1 != objStr2 || objStr1 != objStr3 || objStr1 != objStr4)
                throw info_except("Objects are different.\nObj1:\n%s\nObj2:\n%2\nObj3:\n%s\nObj4:\n%s\n", ~objStr1, ~objStr2, ~objStr3, ~objStr4);
        }
        ...
        static void Test_Constructor(int methOut) { 
            ...
            constr1->Childs.push_back(new TSimpleContructor::TRegData("EOSTest", new TSimpleContructor::TRegData, 5, TSimpleContructor::TRegData::TGridVar("Y", 1, 2)));
...
cout<<" objStr1\n"<<objStr1<<"\n";
            ...
            if (objStr1 != objStr2 || objStr1 != objStr3 )
                throw info_except("OutMethod is %i\nObjects are different.\nObj1:\n%s\nObj2:\n%s\nObj3:\n%s\n", methOut, ~objStr1, ~objStr2, ~objStr3);
        }
