...
double IntExpInf(double b, double q, double x0) {
    ...
    return exp(-abd * x0) / sqr(abd2 + q2) *
           (q * cos(qx0) * (x0 * abd2 + 2 * abd + q2 * x0) +
            sin(qx0) * (q2 * (abd * x0 - 1) + abd2 * (abd * x0 + 1)));
}
...
double IntPow6Inf(double q, double x0) {
    ...
    return ((cos(qx0) * qx0 * (2 - qx2) + sin(qx0) * (6 - qx2)) / x4 +
            (0.5 * M_PI - SiQ) * q4) /
           24;
}
// ============================================================
...
double IntPow6Inf_Strict(double q, double x0) {
    ...
    if(x > 16.)
        goto L10;
    t = x2 * .0078125 - 1.;
    y = t * (t * (t * (t * (t * (t * (t * (t * (t * (t * (t * (t * (t * (t * (t * (t * (t * (t * (t * (t * (t * (t * 1.13364013523612467e-12 -
                                                                                                                 1.73295770867796541e-11) +
                                                                                                            2.34653547501289734e-10) -
                                                                                                       2.9387085702927766e-9) +
                                                                                                  3.30969553150126728e-8) -
                                                                                             3.32784295002924013e-7) +
                                                                                        2.96606267125684584e-6) -
                                                                                   2.32323765441590923e-5) +
                                                                              1.58305204989030543e-4) -
                                                                         9.27069661302843286e-4) +
                                                                    0.00459705459778527538) -
                                                               0.0189410064147072063) +
                                                          0.0632412080713534156) -
                                                     0.165103602060387617) +
                                                0.31828183819586503) -
                                           0.40419356081893966) +
                                      0.229433945244285525) +
                                 0.161990304098876091) -
                            0.334271212963463397) +
                       0.0886834755381626329) +
                  0.132473585260859799) -
             0.11050677668138556) +
        0.137060472876350089;
    SiQ = x * y;
    return ((cos(x) * x * (2 - x2) + sin(x) * (6 - x2)) / x4 + 0.5 * M_PI - SiQ) * q4 /
           24;
L10:
    y = x2;
    t = 512. / y - 1.;
    f = t * (t * (t * (t * (t * (t * (t * (t * (t * (t * (t * (t * (t * (t * (t * (t * 4.8699066372784128e-14 -
                                                                                   1.09176921093439488e-13) +
                                                                              6.3498988357705728e-14) -
                                                                         2.39368626222505984e-13) +
                                                                    1.15517351776520397e-12) -
                                                               3.55518881942203699e-12) +
                                                          1.17023188129910753e-11) -
                                                     4.39951217228505001e-11) +
                                                1.84001853732121956e-10) -
                                           8.7433384997443117e-10) +
                                      4.87245424704650801e-9) -
                                 3.32013637685389532e-8) +
                            2.93937999539516224e-7) -
                       3.71218824655850721e-6) +
                  7.82215041547366874e-5) -
             0.00373729126869038934) +
        .99618044190788651;
    g = t * (t * (t * (t * (t * (t * (t * (t * (t * (t * (t * (t * (t * (t * (t * (t * (t * (t * 2.43669269913534464e-13 -
                                                                                             4.81013570050588672e-13) -
                                                                                        1.06265802930487296e-13) -
                                                                                   9.021839656198144e-14) +
                                                                              2.93520978929726259e-12) -
                                                                         7.18307892366012006e-12) +
                                                                    1.70687678062319268e-11) -
                                                               5.22266851938134641e-11) +
                                                          1.71515979253039184e-10) -
                                                     6.02557598370451512e-10) +
                                                2.33450259515872927e-9) -
                                           1.01708486037094415e-8) +
                                      5.11015920578187682e-8) -
                                 3.06745558439750417e-7) +
                            2.31342831851492447e-6) -
                       2.36338137299290861e-5) +
                  3.68834391295988884e-4) -
             0.0108989877894521955) +
        0.98870585937050572;
    return (cos(x) * (x * (2 - x2) / x4 + f / x) + sin(x) * ((6 - x2) / x4 + g / y)) *
           q4 / 24;
}
// ============================================================
// ===================Strict ==================================
...
double MainIntegral(double q) {
    double X = RP->X, Cut = 0, Ec0 = RP->Ec0, Ec1 = RP->Ec1, P6 = RP->P6, E0 = RP->E0,
           E1 = RP->E1;
    if(X > 1)
        Cut = (IntExpInf(Ec1, q, 1) - IntExpInf(Ec1, q, X)) * Ec0;
    else
        X = 1;
...
double PYfunc(double q) {
    ...
    double nc = -1 / (pow(q, 6) * sqr(niu2)) * 24 * niu *
                (sqr(2 * niu + 1) * (sq - q * cq) * q2 * q +
                 ...
                 0.5 * niu * sqr(2 * niu + 1) *
                     ((sqr(q2) - 12 * q2 + 24) * cos(q) - 4 * (q * (q2 - 6) * sq + 6)));
    return (1 / (1 - nc) - 1) * q;
};
...
double UnityIntegral() {
    double X = RP->X, Cut = 0, Ec0 = RP->Ec0, Ec1 = RP->Ec1, P6 = RP->P6, E0 = RP->E0,
           E1 = RP->E1;
    if(X > 1)
        Cut = (IntExpInf1(Ec1, 1) - IntExpInf1(Ec1, X)) * Ec0;
    else
        X = 1;
...
double FreeSSVT(RossParam *par, double Denc, double T) {
    ...
    RP->S_Temp = RP->Rconst / RP->MolVeight * T;
    RP->S_DensDia = Denc / RP->MolVeight;
    //   RP->S_MaxR_PY=6;
    double PY_add;
    ...
    double F = RP->Zero + PY_add -
               RP->S_Temp * (log(max<double>(1 / Denc, MathZer)) + RP->CvId * log(T) +
                             RP->HiT + log(1 - exp(-RP->Tvib / T)));
    return F;
};
...
double InteractFunc(double r) {
    if(r < RP->ParInteract[0])
        return RP->ParInteract[4] * exp(RP->ParInteract[5] * r);
    double Epsilon = RP->ParInteract[1];
    double Alpha = RP->ParInteract[2];
    double Radius = RP->ParInteract[3];
    //cout<<"  "<<r<<" "<<Epsilon/(Alpha-6)*(6*exp(Alpha*(1-r/Radius))-Alpha*pow(Radius/r,6))<<"\n";
    return Epsilon / (Alpha - 6) *
           (6 * exp(Alpha * (1 - r / Radius)) - Alpha * pow(Radius / r, 6));
}
int FreeERossRead(fstream &in, RossParam *&par) {
    ...
    RP = par;
    char tmp[256];
    in >> tmp >> RP->CvId >> tmp >> RP->MolVeight >> tmp >> RP->Zero >> tmp >> RP->HiT >>
        tmp >> RP->Tvib;
    in >> tmp >> RP->ParInteract[1] >> tmp >> RP->ParInteract[2] >> tmp >>
        RP->ParInteract[3];
    ...
    cout << " FreeERoss Entered. Coreleft " << Coreleft() << " Cut A "
         << RP->ParInteract[4] << " Cut B " << RP->ParInteract[5] << "\n";
    //exit(0);
    return 1;
};
