...
//}
// Do not work ? Really?
static ClassDesc DataVector_double_cd(
    typeid(DataVector<double, CopyStructFast<double>>),
    "DataVector_double");
static ClassDesc DataVector_int_cd(
    typeid(DataVector<int, CopyStructFast<int>>),
    "DataVector_int");
