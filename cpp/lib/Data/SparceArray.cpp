...
//SparceArrayInd
DescribedClass *create_SparceArrayInd_cd() {
    return new SparceArrayInd;
}
static ClassDesc SparceArrayInd_cd(
    typeid(SparceArrayInd),
    "SparceArrayInd",
    1,
    "",
    &create_SparceArrayInd_cd);
//SparceArray
