...
NamedRegistry::NamedRegistry (char *name, char* cl_name, char* categor, char *descr, void(*print)(FilterOut&))
{
}
...
void NamedRegistry::init (char *name, char* cl_name, char* categor, char *descr, void(*print)(FilterOut&) )
{
}
