...
public:
    ...
    Node<CONTENTYPE> *blockHelp(Node<CONTENTYPE> *pos, const integer &L, const integer &B)
        const;
...
///////////////////////////////////////////////////////////////////////////////
template <class CONTENTYPE>
void BinTree<CONTENTYPE>::CopyTree(const Node<CONTENTYPE> *From, Node<CONTENTYPE> *&To) {
    // use preorder
    if(From != 0) {   // copy node
...
///////////////////////////////////////////////////////////////////////////////
template <class CONTENTYPE>
BinTreeComplete<CONTENTYPE>::BinTreeComplete(integer MAXLEVEL, const CONTENTYPE &c)
    : maxlevel(MAXLEVEL) {
    assert(maxlevel > 0);
    SetConst(&this->root, maxlevel, c);
}

///////////////////////////////////////////////////////////////////////////////
template <class CONTENTYPE>
BinTreeComplete<CONTENTYPE>::BinTreeComplete(const BinTreeComplete<CONTENTYPE> &Rhs) {
    BinTree<CONTENTYPE>::CopyTree(Rhs.root, this->root);
}
...
///////////////////////////////////////////////////////////////////////////////
template <class CONTENTYPE>
Node<CONTENTYPE> *BinTreeComplete<CONTENTYPE>::block(const integer &L, const integer &B) {
    assert(0 <= L && L <= maxlevel && 0 <= B && B <= (1 << L));
    return blockHelp(this->root, L, B);
}

///////////////////////////////////////////////////////////////////////////////
template <class CONTENTYPE>
Node<CONTENTYPE> *BinTreeComplete<CONTENTYPE>::blockHelp(
    Node<CONTENTYPE> *pos,
    const integer &L,
...
///////////////////////////////////////////////////////////////////////////////
template <class CONTENTYPE>
void BinTreeComplete<CONTENTYPE>::SetConst(
    Node<CONTENTYPE> **ptr,
    const integer &L,
    const CONTENTYPE &c) {
    if(L > 0) {
